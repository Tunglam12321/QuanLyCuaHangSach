...
namespace QuanLyCuaHangSach
{
    public partial class Timkiem : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int i = 0;
            int.TryParse(tb_timkiem.Text, out i);
            adapt2 = new SqlDataAdapter(" select * from Bills where bookname ='" + tb_timkiem.Text + "' or IDbills=" + i + "", con);
            tblUser2.Clear();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int i = 0;
            int.TryParse(tb_timkiem.Text, out i);
            adapt1 = new SqlDataAdapter(" select * from NhapSach where Booktitle ='" + tb_timkiem.Text + "' or IDimport=" + i + "", con);
            tblUser1.Clear();
